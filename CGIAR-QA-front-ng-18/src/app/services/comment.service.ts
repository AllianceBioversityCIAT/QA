...
export class CommentService {
  ...
  getCommentCRPStats(params) {
    return this.http.get<any>(
      `${environment.apiUrl}/comment/?crp_id=${params.crp_id}&id=${params.id}`
    );
  }
  ...
  getDataComment(params) {
    return this.http.get<any>(
      `${environment.apiUrl}/evaluation/${params.evaluationId}/detail/comment/${params.metaId}`
    );
  }
  ...
  createDataCommentReply(params) {
    return this.http.post<any>(
      `${environment.apiUrl}/evaluation/detail/comment/reply`,
      params
    );
  }
  ...
  getDataCommentReply(params) {
    return this.http.get<any>(
      `${environment.apiUrl}/evaluation/${params.evaluationId}/detail/comment/${params.commentId}/replies`
    );
  }
  ...
  getRawComments(params) {
    return this.http.get<any>(
      `${environment.apiUrl}/comment/raw/${params.crp_id}`
    );
  }
  ...
  updateCycle(params) {
    return this.http.patch<any>(
      `${environment.apiUrl}/comment/cycles/update`,
      params
    );
  }
  // get comments excel
  toggleApprovedNoComments(params, evaluationId) {
    return this.http.post(
      `${environment.apiUrl}/comment/approved/${evaluationId}`,
      params
    );
  }
  ...
  createTag(params) {
    return this.http.post<any>(
      `${environment.apiUrl}/evaluation/detail/comment/tag`,
      params
    );
  }
  ...
  deleteTag(id) {
    return this.http.delete<any>(
      `${environment.apiUrl}/evaluation/detail/comment/tag/${id}`
    );
  }

  getTagId(params) {
    return this.http.get<any>(
      `${environment.apiUrl}/evaluation/detail/comment/tag/${params.commentId}/${params.tagTypeId}/${params.userId}`
    );
  }

  getAllTags(crp_id?) {
    return this.http.get<any>(
      `${environment.apiUrl}/comment/tags/?crp_id=${crp_id}`
    );
  }

  getFeedTags(indicator_view_name, tagTypeId?) {
    return this.http.get<any>(
      `${environment.apiUrl}/comment/tags/feed/?indicator_view_name=${indicator_view_name}&tagTypeId=${tagTypeId}`
    );
  }
