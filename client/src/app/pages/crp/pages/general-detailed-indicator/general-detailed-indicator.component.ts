...
export default class GeneralDetailedIndicatorComponent implements OnInit {
  ...
  AIMatchFields = ["gender_tag_level", "climate_change_level", "nutrition_tag_level", "environmental_biodiversity_tag_level", "poverty_tag_level", "innovation_readiness_level", "result_type", "current_use_level_of_the_innovation", "actors_organizations_quantitative"]
