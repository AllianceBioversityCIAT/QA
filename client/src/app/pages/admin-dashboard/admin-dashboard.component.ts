...
export default class AdminDashboardComponent implements OnInit {
  ...
  enableCommentsTooltip: string =
    'If this option is enabled, SP/A will be able to see all comments provided by the Quality Assessors in PRMS Reporting tool; and also will be able to react to the comments.';
  ...
  actualIndicator() {
    ...
    let responses = forkJoin([this.getFeedTags(this.selectedIndicator), this.getItemStatusByIndicatorService(this.selectedIndicator, crp_id)]);
