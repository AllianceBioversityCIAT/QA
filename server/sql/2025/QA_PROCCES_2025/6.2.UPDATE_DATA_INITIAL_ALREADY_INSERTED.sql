-- Update data_initial already inserted: refresh qa_*_data_initial from views only for results
-- that are in_qa in the view but do NOT yet exist in qa_evaluations.
-- Use this on subsequent QA runs after 4.1.INSERT_VIEW_TO_DATA_INITIAL.sql.
SET
    SQL_SAFE_UPDATES = 0;
...
WHERE
    ...
    AND EXISTS (
        ...
        WHERE e.indicator_view_id = cc.id
          ...
          AND e.createdAt >= '2026-03-08 12:00:00'
    );
